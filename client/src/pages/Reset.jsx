...
const Reset = () => {
  ...
  return (
    ...
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-blue-200 to-purple-400 p-8 sm:p-8 ">
      ...
      {!isEmailSent && <form onSubmit={onSubmitEmail} className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm relative">
        ...
        <div className='mb-4 flex gap-3 items-center w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
          ...
          <input type="email" name="" id="" placeholder='Email id' className='bg-transparent outline-none text-white text-xl'
      ...
      {!isOtpSubmitted && isEmailSent &&
       <form onSubmit={onSubmitOtp } className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm">
        ...
        {/* enter new password */}
        {isOtpSubmitted && isEmailSent &&
        <form onSubmit={onSubmitNewPassword} className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm relative">
        ...
        <div className='mb-4 flex gap-3 items-center w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
          ...
          <input type="password" name="" id="" placeholder='new password' className='bg-transparent outline-none text-white text-xl'
